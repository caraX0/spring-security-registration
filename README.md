...
If you want to use the MySQL instead, you need to uncomment relevant section in the [persistence.properties](persistence.properties) and create the db user as shown below:
```
mysql -u root -p 
